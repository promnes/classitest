    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div
            ref={panelRef}
            className={`fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-16 sm:top-full sm:mt-2 z-50 w-auto sm:w-[420px] max-h-[80vh] rounded-2xl shadow-2xl border overflow-hidden ${
